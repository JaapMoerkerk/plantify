          ...
          <View style={styles.contactBox}>
            <View style={styles.userInfo}>
              <View style={styles.contactCircle}>
                <Image source={require('./img/contact/woman.png')} style={styles.contactLogo} />
              </View>
            ...
            <View style={styles.contactOption}>
              <View style={styles.contactCircle}>
                <Image source={require('./img/contact/email.png')} style={styles.contactLogo} />
              </View>
              <Text style={styles.contactInfo}>mailadress@mail.com</Text>
            </View>
            <View style={styles.contactOption}>
              <View style={styles.contactCircle}>
                <Image source={require('./img/contact/camera.png')} style={styles.contactLogo} />
              </View>
              <Text style={styles.contactInfo}>@instagram_user</Text>
            </View>
            <View style={styles.contactOption}>
              <View style={styles.contactCircle}>
                <Image source={require('./img/contact/bird.png')} style={styles.contactLogo} />
              </View>
